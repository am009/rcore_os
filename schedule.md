...
下午写笨办法学C练习17的时候遇到了困难. 前面对Box的理解问题想明白了, 但是后面对生命周期标记查资料的时候实验有些卡住在无关紧要的问题上了... 研究了半天, 甚至彻底忘了自己要做什么... 又浪费了一个小时. 我在这种时候往往不能迅速转换心态, 继续完成之前的事情, 以前我经常这时候停止学习, 第二天再来...忘了那个无关紧要的问题吧.
...
先从简单的开始吧, 一边补齐各个lab的练习题, 一边整理笔记

<span id="021"></span>
## Day 21 (2020-07-24)

修笔记修得太久浪费了太多时间. 我该早点去写练习题的.
看了看练习题, 还是适合完全写完lab之后去做. 赶紧完成自己的lab吧

<span id="022"></span>
## Day 22 (2020-07-25)

今天开始继续做lab, 下午一点半的时候遇到了bug, 页表出现了问题. 无论是自己写程序检查页表还是qemu中手动检查satp寄存器一路寻找页表, 页表都是对的, 但是就是不能访问, gdb中也不能访问对应地址的内存... 不知道为什么... 下次再来吧

之前学rcore, 写笔记以为自己很懂, 其实真正做起练习来还是有点艰难... 尤其是线段树, 这个数据结构不太懂, OI基础弱.

明天是deadline, 我1要把学习报告整理出来. 2要把各个lab里的问题整理好准备发一个issue 3要准备完成各种试验题 4要着手开始看树莓派armv8的代码

<span id="023"></span>
## Day 23 (2020-07-26)

今天下午的交流说明了各种事情.
今天写了一篇学习总结到blog, 完成了lab4 上 实验题中fork的实现.
自己进度确实和预想的落后了不少, 一方面是去玩两天回来之后效率一开始没之前高了, 还花了不少时间专门修笔记, 其次就是以为deadline是8月1号. 
之前的预想是回来后两天完成最后一个lab, 这个没想到花了接近三天, 然后是没有仔细考虑好挑战练习的难度.
现在赶紧把挑战练习做完吧, 在check之前, 有时间把之前写了个开头的笨办法学的练习写了, 最后再开始看rust树莓派os的代码.

感觉自己后面就没怎么关注issue了, 他们都在讨论实验题的事情, 而我由于之前做的时候实验题没出来, 原计划是手打代码就这样学过来, 导致没有及时去做实验题.
...
今天完成了和lab6的实验题和挑战实验题. lab2的实验题里面的那些算法有些不熟, 前几天看了看buddy_system. lab3实验, 如果是页面置换也就算了, 要我比较各种算法的好坏就感觉不太好下手了, 感觉要用一个参数限制一下最大使用的内存页, 不然内存就都是够用的. lab4 下的stride scheduling 也需要学习一下. 慢慢来吧...

总的来说, 学操作系统印象中遇到的困难挺多的, 而且也不是特别容易克服. 操作系统实战起来要考虑的因素太多太多, 涉及的知识一下就广了起来. 尤其是软件一旦大了起来就不太容易看懂了... rcore-Tutorial 确实没有ucore难.
...
感到自己在参与活动的时候还是太被动, 只想着学, 不能及时帮上什么忙. yunwei37就比较厉害, 能抓住文档中需要改的部分去直接提pull request. 文档中确实有很多我觉得需要改的地方, 但总感觉自己改不太合适...

没想到时钟置换算法似乎还挺简单的. 而且似乎lab3+的实验框架能自己打印出来缺页次数. 不知道为什么还是209次, 和FIFO没有区别. 
