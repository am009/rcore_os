...
今天完成了和lab6的实验题和挑战实验题. lab2的实验题里面的那些算法有些不熟, 前几天看了看buddy_system. lab3实验, 如果是页面置换也就算了, 要我比较各种算法的好坏就感觉不太好下手了, 感觉要用一个参数限制一下最大使用的内存页, 不然内存就都是够用的. lab4 下的stride scheduling 也需要学习一下. 慢慢来吧...管不了那么多了

总的来说, 学操作系统遇到的困难挺多的. 而且也不是特别容易克服. 操作系统实战起来要考虑的因素太多太多, 涉及的知识一下就广了起来.
