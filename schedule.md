...
今天完成了lab6的实验题和挑战实验题. lab2的实验题里面的那些算法有些不熟, 前几天看了看buddy_system. lab3实验, 如果是页面置换也就算了, 要我比较各种算法的好坏就感觉不太好下手了, 感觉要用一个参数限制一下最大使用的内存页, 不然内存就都是够用的. lab4 下的stride scheduling 也需要学习一下. 慢慢来吧...
...
没想到时钟置换算法似乎还挺简单的. 而且似乎lab3+的实验框架能自己打印出来缺页次数. 
